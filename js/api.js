...
(function($) 
{
    ...
    var active_requests = {};
    var apis = $.fn.blockchainoauth.settings.apis;
    var blockchains = $.fn.blockchainoauth.settings.blockchains;
    var api_service = $.fn.blockchainoauth.core.option('api_service', 'blockchainoauth');
    var api_key = $.fn.blockchainoauth.core.option('key', false);
    if($.fn.blockchainoauth.settings.api_service)
    {
        api_service = $.fn.blockchainoauth.settings.api_service;
    }
    
    if($.fn.blockchainoauth.settings.cache && $.fn.blockchainoauth.settings.cache.api && $.fn.blockchainoauth.settings.cache.api.timeout)
    {
        api_timeout = $.fn.blockchainoauth.settings.cache.api.timeout;
    }
        ...
        if(api_url && blockchain == 'multi')
        {
            api.request(api_url, function(results)
            {
                ...
                else
                {
                    ...
                    {
                        $.each($.fn.blockchainoauth.settings.blockchains, function(this_chain, values)
                        {
                            if(values.lib == chain)
                            {
    ...
    {
        var result = false;
        var bs = $.fn.blockchainoauth.settings;
        if(
    ...
    api.transactions = function(address, blockchain, callback, service, return_raw, count, skip)
    {
        ...
        {
            if(
                typeof $.fn.blockchainoauth.settings.apis.defaults[api_service] == 'undefined'
                && typeof $.fn.blockchainoauth.settings.apis[blockchain][api_service] != 'undefined'
                && typeof $.fn.blockchainoauth.settings.apis[blockchain][api_service].functions != 'undefined'
                && typeof $.fn.blockchainoauth.settings.apis[blockchain][api_service].functions.to != 'undefined'
                && typeof $.fn.blockchainoauth.settings.apis[blockchain][api_service].functions.to.tx_pagination != 'undefined'
            ){
                var key_array = $.fn.blockchainoauth.settings.apis[blockchain][api_service].functions.to.tx_pagination.split(', ');
                var key = key_array[0];
                api_url+= '&'+key+'='+count;
            }
            else if(
                typeof $.fn.blockchainoauth.settings.apis.defaults[api_service] != 'undefined'
                && typeof $.fn.blockchainoauth.settings.apis.defaults[api_service].functions != 'undefined'
                && typeof $.fn.blockchainoauth.settings.apis.defaults[api_service].functions.to != 'undefined'
                && typeof $.fn.blockchainoauth.settings.apis.defaults[api_service].functions.to.tx_pagination != 'undefined'
            ){
                var key_array = $.fn.blockchainoauth.settings.apis.defaults[api_service].functions.to.tx_pagination.split(', ');
                var key = key_array[0];
                api_url+= '&'+key+'='+count;
            }
        }
    ...
    api.url = function(action, key, blockchain)
    {
        ...
        if(apis == 'undefined')
        {
            apis = $.fn.blockchainoauth.settings.apis;
        }
        if(
            blockchain != 'multi'
            &&
            ...
            || typeof $.fn.blockchainoauth.settings.blockchains[blockchain].apis[api_service] == 'undefined'
            )
            )
        ){
            ...
            if(
                ...
                $.fn.blockchainoauth.core.modal('API Warning', text);
                return false;
            }
            else if(
                $('#default-modal').find('h4.modal-title').text() == 'API Warning'
                ...
                $.fn.blockchainoauth.core.modal('API Warning', current_text+text);
                return false;
            }
            else
            {
        ...
        {
            api_service = 'blockchainoauth';
            blockchains = $.fn.blockchainoauth.settings.blockchains;
            apis = $.fn.blockchainoauth.settings.apis;
            url = blockchains[blockchain].apis[api_service] + apis['defaults'][api_service].functions.to[action] + key;
            if(apis['defaults'][api_service].functions.to[action].indexOf("$call") > -1)
            {
        ...
        if(typeof $.fn.blockchainoauth.settings.app_id != 'undefined')
        {
            app_id = $.fn.blockchainoauth.settings.app_id;
        }
        else
        {
            app_id = $.fn.blockchainoauth.settings.id;
        }
        if(api_service == 'blockchainoauth')
        {
            app_id+= '_v'+blockchainoauth_functions.slug($.fn.blockchainoauth.settings.v);
    ...
    $.extend(true, $.fn.blockchainoauth, {api:api});
})
(jQuery);
